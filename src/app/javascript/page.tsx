import { Button, withMotionWrapped } from '@/components/atoms'
import Typography from '@/components/atoms/Typography'
import { PageContent } from '@/components/molecules'
import { Alert, HR, List, ListItem } from 'flowbite-react'
  ...
  return (
    <>
      ...
      <Typography>
        ...
        language with first-class functions. It brings life, interaction, and
        logic to websites and web applications. Imagine a website as a body —
        HTML is the skeleton, CSS is the skin and style, and JavaScript is the
        brain that makes it think, move, and respond.
      </Typography>
      <Typography mode="h6">Here’s the magic:</Typography>

      <MotionList className="space-y-1 list-disc list-inside text-gray-300 mb-4">
        <ListItem>
          <Typography mode="b-text">Without JavaScript:</Typography> A button on
          a website is just a decoration.
        </ListItem>
        <ListItem>
          <Typography mode="b-text">With JavaScript:</Typography> That button
          can click, show alerts, fetch data from servers, play music, and much
          more!
        </ListItem>
      </MotionList>
      ...
      <Typography>
        JavaScript is a core technology of the World Wide Web. It's used in many
        non-browser environments, such as Node.js, Apache CouchDB, and Adobe
        Acrobat. It is a lightweight, interpreted, prototype-based,
      ...
      <Typography>
        ...
        <Typography mode="b-text">Netscape 2</Typography>. But at that time the
        most popular programming language was{' '}
        ...
        <Typography mode="b-text">JavaScript</Typography>. In short we call it,{' '}
        <Typography mode="b-text">JS</Typography>.
      </Typography>
      <Alert
        color="failure"
